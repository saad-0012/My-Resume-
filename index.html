...
<body>
    <header>
        ...
        <div class="contact-info">
            <ul>
                <li><i class="fas fa-phone-alt"></i>7028352298</li>
                <li><i class="fas fa-envelope"></i> <a href="mailto:rafikshah3262@gmail.com">rafikshah3262@gmail.com</a></li>
                <li><i class="fab fa-linkedin"></i> <a href="https://www.linkedin.com/in/rafik-shah-179875209/" target="_blank">LinkedIn</a></li>
                <li><i class="fab fa-github"></i> <a href="https://github.com/RAFIKSHA" target="_blank">GitHub</a></li>
            </ul>
        </div>
    </header>
    ...
    <footer>
        <p>©2024 Rafik Shah. All rights reserved.</p>
    </footer>
